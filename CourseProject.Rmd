...
Based on the information above, like [@Velloso1], we can see that the Random Forest model is the most accurate. We show below the decision tree of the final model.
